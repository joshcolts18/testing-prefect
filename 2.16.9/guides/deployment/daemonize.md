...
We will leverage systemd and see how to automatically start a [Prefect worker](/2.16.9/concepts/work-pools/#worker-overview) or long-lived [`serve` process](/2.16.9/concepts/flows/#serving-a-flow) when Linux starts.
...
* If daemonizing a worker, you'll need a Prefect [deployment](/2.16.9/concepts/deployments/) with a [work pool](/2.16.9/concepts/work-pools/) your worker can connect to.
...
Check out other [Prefect guides](/2.16.9/guides/) to see what else you can do with Prefect!
