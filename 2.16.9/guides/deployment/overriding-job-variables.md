...
As described in the [Deploying Flows to Work Pools and Workers](/2.16.9/guides/prefect-deploy/) guide, there are two ways to deploy flows to work pools: using a `prefect.yaml` file or using the `.deploy()` method.
...
![Job variables in the UI](/2.16.9/img/guides/job-variables.png)
