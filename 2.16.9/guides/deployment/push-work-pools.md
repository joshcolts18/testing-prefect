...
Push [work pools](/2.16.9/concepts/work-pools/#work-pool-overview) are a special type of work pool that allows Prefect Cloud to submit flow runs for execution to serverless computing infrastructure without running a worker.
...
=== "Google Cloud Run"
    ...
    ![Configuring service account permissions in GCP](/2.16.9/img/guides/gcr-service-account-setup.png)
...
=== "Google Cloud Run"
    ...
    ![Configuring GCP Credentials block for use in cloud run push work pools](/2.16.9/img/guides/gcp-creds-block-setup.png)
...
=== "AWS ECS"
    ...
    Each step has several optional fields that are detailed in the [work pools documentation](/2.16.9/concepts/work-pools/). 
...
Deployment details are described in the deployments [concept section](/2.16.9/concepts/deployments/).
...
![A flow running on a cloud run push work pool](/2.16.9/img/guides/push-flow-running.png)

## Next steps

Learn more about workers and work pools in the [Prefect concept documentation](/2.16.9/concepts/work-pools/).

Learn about installing dependencies at runtime or baking them into your Docker image in the [Deploying Flows to Work Pools and Workers guide](/2.16.9/guides/prefect-deploy/#creating-work-pool-based-deployments-with-deploy).
