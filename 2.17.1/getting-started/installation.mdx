...
See our [Contributing](/2.17.1/contributing/overview/) guide for more details about standards and practices for contributing to Prefect.
...
Linux is a popular operating system for running Prefect. You can use [Prefect Cloud](/2.17.1/ui/cloud/) as your API server, or [host your own Prefect server](/2.17.1/host/) backed by [PostgreSQL](/2.17.1/concepts/database/#configuring_a_postgresql_database).

For development, you can use [SQLite](/2.17.1/concepts/database/#configuring_a_sqlite_database) 2.24 or newer as your database. Note that certain Linux versions of SQLite can be problematic. Compatible versions include Ubuntu 22.04 LTS and Ubuntu 20.04 LTS.
...
You can use [Prefect Cloud](/2.17.1/ui/cloud/) as your API server, or [host your own Prefect server](/2.17.1/host/) backed by [PostgreSQL](/2.17.1/concepts/database/#configuring_a_postgresql_database).
...
Now that you have Prefect installed and your environment configured, you may want to check out the [Tutorial](/2.17.1/tutorial/) to get more familiar with Prefect.
