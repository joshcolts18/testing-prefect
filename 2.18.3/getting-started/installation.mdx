...
You can use [Prefect Cloud](/2.18.3/ui/cloud/) as your API server or [host your own Prefect server instance](/2.18.3/host/) backed by [PostgreSQL](/2.18.3/concepts/database/#configuring_a_postgresql_database).
For development, you can use [SQLite](/2.18.3/concepts/database/#configuring_a_sqlite_database) 2.24 or newer as your database.

[Prefect Cloud](/2.18.3/cloud/) is a managed solution that provides strong scaling, performance, and security.
...
See our [Contributing guide](/2.18.3/contributing/overview/) for instructions on installing Prefect for development and see the [section below](#installing_unreleased_code) to install directly from the `main` branch.
...
!!! note
    Note that in production we recommend using [Prefect Cloud](/2.18.3/ui/cloud/) as your API server or [hosting your own Prefect server instance](/2.18.3/host/) backed by [PostgreSQL](/2.18.3/concepts/database/#configuring_a_postgresql_database).
...
Now that you have Prefect installed and your environment configured, check out the [Tutorial](/2.18.3/tutorial/) to get more familiar with Prefect.
